import { SELECT_OPTIONS, tools } from "@/app/(site)/_tools-category/topic-page/page";
    ...
    <main className="relative isolate bg-slate-950 text-white">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16 text-center">
        ...
        <p className="mt-4 max-w-2xl mx-auto text-slate-300">
          Compare 2 AI Automation tools. Find free trials, pricing, and real user reviews.
        </p>

        {/* Searchbox */}
        <Searchbox />

        <ul className="mt-8 flex flex-wrap justify-center gap-6 sm:gap-3 text-sm font-semibold">
        ...
        <div className=" flex flex-col lg:flex-row items-center justify-center mt-10 gap-6">
          ...
          <p className="text-sm bg-linear-to-r from-amber-400 to-red-300
           bg-clip-text text-transparent font-semibold">Join 50,000+ AI enthusiasts finding better tools</p>
        </div>
