      ...
      <div className="w-full max-w-7xl mx-auto px-6 lg:px-10">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="w-full max-w-lg">
            ...
            <form className="rounded-2xl bg-slate-950 p-6 space-y-5 text-white">
              {/* Email */}
              <div>
                ...
                <div className="mt-1 relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-2 rounded-md bg-black 
              ...
              <div>
                ...
                <div className="mt-1 relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-10 py-2 rounded-md bg-black border border-white/20
              ...
              <p className="text-center text-sm text-slate-400">
                ...
                <Link href="/signup" className="bg-linear-to-r from-cyan-400 to-purple-400 bg-clip-text text-transparent font-medium hover:underline">
                  Sign up
                </Link>
              </p>
            </form>
