...
export default function Newsletter() {
    return (
        <div className="rounded-xl bg-linear-to-br from-slate-700 to-indigo-950 p-6 border border-cyan-400/40">

            <Image src={'/bliss.svg'} alt="bliss-icon-svg" width={80} height={80}
                className="mx-auto w-16 h-16" />

            <h4 className="font-semibold text-center mt-4 text-xl">Stay Updated!</h4>
            <p className="text-sm text-slate-300 mt-2 text-center w-[95%]">
                Get the latest AI tools, updates, and insights delivered to your inbox weekly.
            </p>
            <input
                placeholder="Enter your email"
                className="mt-4 w-full rounded-md bg-black/50 border border-white/10 px-4 py-2 text-sm"
            />
            ...
            <p className="mt-6 text-xs text-center text-slate-400">
                Join <span className="text-cyan-400 font-semibold">50k+ AI enthusiasts</span>
            </p>
        </div>
    )
}
