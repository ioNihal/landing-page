import { Search, Filter, Bookmark, BarChart3, Target, Shield, Zap, Sparkles } from "lucide-react";
        ...
        <section className="relative bg-slate-950 text-white px-4 sm:px-6 lg:px-10 py-24 isolate">
            ...
            <div className="max-w-6xl 2xl:max-w-7xl mx-auto">
                ...
                <div className="text-center max-w-3xl mx-auto mb-20">
                    ...
                    <p className="mt-6 text-slate-300 text-sm sm:text-lg leading-relaxed">
